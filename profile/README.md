...
- Focus on stability. Introduce only minimized out-of-tree tweaks:
    ...
    - Remove builtins `PropImitationHooks`. **This will cause you fail `Play Integrity` by default**.
        - You should use [Tricky Store](https://github.com/5ec1cff/TrickyStore) instead (which will also helps you pass **strong integrity**!).
